        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (response.StatusCode == HttpStatusCode.Unauthorized)
            {
                ...
                try
                {
                    ...
                    var user = await DependencyService.Get<IAuthentication>().LoginAsync(this.Client, MobileServiceAuthenticationProvider.Google);
                    ...
                    CashApp.Helpers.Settings.UserId = user.UserId;
                    CashApp.Helpers.Settings.AuthToken = user.MobileServiceAuthenticationToken;
                ...
                {
                    await userDialog.AlertAsync(string.Format("Failed login. Error : {0}", ex.Message));
                    return response;
                }
            }
